...
export const ideathonCategories: IdeathonCategory[] = [
  ...
  {
    name: "Sustainable Food & Nutrition",
    description: "Transforming and promoting eco-friendly production, minimizing waste and delivering affordable, nutrient-rich solutions.",
    iconName: "Recycle",
    imageSrc: "https://placehold.co/600x400.png",
  ...
  },
  {
    ...
    description: "Innovative solutions to reduce, reuse, and recycle plastics in Fashion, Food and Tourism Sector .",
    iconName: "Trash2",
    imageSrc: "https://placehold.co/600x400.png",
  ...
  },
  {
    ...
    description: "Transforming Trash to Treasure: Sustainable Innovations in Fashion, Food and Tourism for a Greener Tomorrow.",
    iconName: "RefreshCw",
    imageSrc: "https://placehold.co/600x400.png",
